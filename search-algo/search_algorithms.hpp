...
//  * Binary Search  - O(log n), REQUIRES the vector to be sorted by id
//  ascending. A helper `sortByIdAscending` is provided so callers can prepare a
//  sorted copy.
// ============================================================================
...
// ---------------------------------------------------------------------------
inline std::vector<Product>
sortByIdAscending(const std::vector<Product> &products)
{
...
// ---------------------------------------------------------------------------
//  Binary Search
//  Repeatedly halves the search range. REQUIRES `products` sorted by id
//  ascending. Time: O(log n). Returns the index within the given (sorted)
//  vector, or -1.
// ---------------------------------------------------------------------------
